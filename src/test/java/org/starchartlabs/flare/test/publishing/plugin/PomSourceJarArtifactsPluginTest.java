/*
 * Copyright (c) Jul 4, 2017 Corona IDE.
...
public class PomSourceJarArtifactsPluginTest {

    private static final String PLUGIN_ID = "org.starchartlabs.flare.pom-source-jar-artifacts";
    ...
    @Test
    public void javadocJarTaskAdded() throws Exception {
